...
function HomePage() {
    ...
    return (
        ...
        <a href="PUT LIKNS IN HERE" target="_blank" class="button first"><button>Information</button><span></span></a>
        
        <a href="PUT LINKS IN HERE" target="_blank" class="button sec"><button>Our Mission</button><span></span></a>
        
        <a href="PUT LINKS IN HERE" target="_blank" class="button third"><button>Map</button><span></span></a>
        ...
        <div class="titleSmall">
            ...
            <p>Every Drop Counts: Raising Awareness, Inspiring Change </p>
